          ...
          <div class="container">
            <div class="form-outer text-center d-flex align-items-center">
              <div class="form-inner" style="padding:40px 100px;">
                ...
                <p>XpeedStudio Buyer Management Web Application</p>
                               
                <div id="loginMessageDiv">
                  <br> 
                  <div class="alert" id="loginMessage">
                    <strong>Success!</strong> Indicates a successful or positive action.
                  </div>                  
                </div>

                <form class="text-left" id="loginFrom">
                  ...
                  <div class="form-group text-center">
                    <input id="login" type="submit" class="btn btn-primary" value="Login" onclick="checkLogin()">
                    </div>
                  </form>
                </div>
